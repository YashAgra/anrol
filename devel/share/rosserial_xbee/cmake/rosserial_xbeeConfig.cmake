...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/zepgar/anrol_ws/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/zepgar/anrol_ws/devel)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/zepgar/anrol_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zepgar/anrol_ws/src/rosserial/rosserial_xbee/${idir}'.  ${_report}")
    endif()
